		...
		<div class="container">
			...
			<div class="single_slider_wrapper main_slider scroll-anim <?php if(!$has_slider){ echo "no_slider"; }?>" data-anim="fade-up">
				...
				<div class="banner-text text-center pos-abs-top">
					<!-- <div class="location-text ucase" itemprop="legalName"><?php echo $top_most_parent_post->post_title;?></div> -->
					<h2 itemprop="legalName" class="ucase"><?php echo $page_heading; ?></h2>
				</div>
			</div>
