...
Container::make('post_meta', 'Slider Images')
    ->show_on_post_type('hotel')
    ->show_on_template(array('template-hotellanding.php','template-room.php','template-restaurant.php','template-facilities.php','template-gym.php','template-spa-wellness.php'))
    ->add_fields(array(
